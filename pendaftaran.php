...
<head>
    ...
    <title>Registrasi - Pelatihan Kerja</title>
                                ...
                                <div class="card-body">
                                    <form method="post" action="./functions/register_function.php">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="no_telpon" name="no_telpon"
                                                        type="tel" placeholder="Nomor Telepon" required />
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="tempat_lahir" name="tempat_lahir"
                                                        type="text" placeholder="Tempat Lahir" required />
                                        ...
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><button class="btn btn-primary"
                                                    type="submit">Registrasi</button></div>
                                        </div>
                                    </form>
                                </div>
